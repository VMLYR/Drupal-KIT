// IE fix: https://github.com/e-oj/Magic-Grid/tree/8c4e4005cef0a210dd7c65f604eac32fa2ad939b
!(function (t, e) {
  ...
  var t = function (t) {
    ...
    i = function (t) {
      for (var e = t[0], i = 0; i < t.length; i++) t[i].height < e.height && (e = t[i]);
      return e;
    },
    n = function (e) {
      t(e),
        e.container instanceof HTMLElement ? ((this.container = e.container), (this.containerClass = e.container.className)) : ((this.containerClass = e.container), (this.container = document.querySelector(e.container))),
        (this.items = this.container.children),
        (this.static = e.static || !1),
        (this.size = e.items),
        (this.gutter = e.gutter),
        (this.maxColumns = e.maxColumns || !1),
        (this.useMin = e.useMin || !1),
        (this.useTransform = e.useTransform),
        (this.animate = e.animate || !1),
        (this.started = !1),
        this.init();
    };
  return (
    ...
    (n.prototype.setup = function () {
      ...
      for (var s = 0; s < i; s++) n[s] = { height: 0, index: s };
      return { cols: n, wSpace: t - i * e + this.gutter };
    }),
