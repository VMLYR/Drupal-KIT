 ...
 * EXAMPLE 1:
 *
\$\(once\('js-once-my-behavior', * $('.some-link', context))).click(function () {
 *   // Code here will only be applied once
 * });
 *
 * EXAMPLE 2:
 *
\$\(once\('js-once-my-behavior', * $('.some-element', context))).each(function () {
  ...
  self.cardLink = function(elements, linkSelector, fallbackSelector) {
    ...
    $(once('js-once-cardlink', elements)).each(function() {
      ...
      if (typeof link !== 'undefined' && link !== null && link.length) {
        ...
        $(once('js-once-cardlink-mouseup')).on('mouseup', function(e) {
  ...
  self.scrollToAnchor = function(offset) {
    ...
    if (animatedScrolling) {
      ...
      $(once('js-once-scrollable-anchors', anchorLinks)).each(function() {
        ...
        $(once('js-once-scrollable-anchor-click', anchorLink)).each(function() {
...
})(jQuery, Drupal, window, document, window.once);
