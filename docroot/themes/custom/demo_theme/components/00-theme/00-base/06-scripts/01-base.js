  ...
  self.scrollToAnchor = function(offset) {
    ...
    if (animatedScrolling) {
      ...
      if ( $(urlHash).length ) {
        ...
        $(once('js-once-scrollable-anchors-active', myAnchorLinks[0])).each(function() {
...
//        myAnchorLinks.once('js-once-scrollable-anchors-active').each(function() {
      ...
      $(once('js-once-scrollable-anchors', anchorLinks[0])).each(function() {
      ...
      window.onpopstate = function(event) {
        $(once('js-once-scrollable-anchors-popstate', anchorLinks[0])).each(function() {
