...
/**
 * Plugin implementation of the 'classy_link_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "classy_link_formatter",
 *   label = @Translation("Classy link formatter"),
 *   field_types = {
 *     "link"
 *   }
 * )
 */
class ClassyLinkFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $elements['classes'] = [
      '#type' => 'textfield',
      '#title' => t('Extra classes. Separate multiple classes with space'),
  ...
  public function settingsSummary() {
    ...
    if (!empty($settings['classes'])) {
      $summary[] = t('Extra classes:') . ' ' . $settings['classes'];
    }
