!function (a, e, s, l) {
  ...
  e.behaviors.rocketshipUIForms = {
    ...
    })), l.length && once("js-once-select", l).each((function () {
      var e = a(this), s = ".form__element";
      e.closest(s).length < 1 && (s = ".form-wrapper"), e.focus((function (e) {
        a(this).parent().parent().find("label").addClass("is-active")
      })).blur((function (e) {
        var l = a(this);
        l.closest(s).removeClass("is-active").find("label").removeClass("is-active"), l.val() ? l.closest(s).addClass("has-value").find("label").addClass("has-value") : l.closest(s).removeClass("has-value").find("label").removeClass("has-value")
    ...
    once("js-once-select-wrap", e).each((function () {
      a(this).closest(".form__dropdown").length < 1 && a(this).wrap('<div class="form__dropdown"></div>')
    }))
  }, t.textareaScroll = function (e) {
    once("js-once-textarea-scroll", e).each((function () {
      var e = a(this), s = function (a) {
