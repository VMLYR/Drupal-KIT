...
// import section3ColTwig from './section--4-col.twig';
import sectionVariantsTwig from './section--4-col--variants.twig';

import sectionData from './section--4-col.yml';
import sectionVariantsData from './section--4-col--variants-vert-align.yml';
 ...
 */
export default {
  title: 'Organisms/Content Sections/4 columns/Vertical align',
