...
import sectionVariantsTwig from './section--1-col--variants.twig';

import sectionData from './section--1-col.yml';
import sectionVariantsData from './section--1-col--variants-spacing-vert.yml';


// ** Merge Text block variants data, as well as the 2-col sections variants
...
// ** Merge Media - video block variants data, as well as the 2-col sections variants
...
// ** Merge FAQ block variants data, as well as the 2-col sections variants
...
// ** Merge Testimonial block variants data, as well as the 2-col sections variants
...
// ** Merge USP block variants data, as well as the 2-col sections variants
...
// documentation
import mdx from './section--1-col.mdx';
 ...
 */
export default {
  title: 'Organisms/Content Sections/1 column/Vertical spacing',
  parameters: { docs: { page: mdx } }, // needed to load an mdx file for documentation: componentName.mdx
};

// ** Section in 1 columns
